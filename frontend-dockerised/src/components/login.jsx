                ...
                <CardContent className='loginCardContent'>
                    ...
                    <Box component='div' className='loginForm'>
                        ...
                        <div className='body'>
                            ...
                            {isLoginView && isError && <><p style={{fontSize:'10px',color:'red'}}>Wrong username or password!!</p> <span style={{color:'blue'}} onClick={() => {setForgot(true); setIsError(!isError);}}>Forgot password</span></>}
                            { isLoginView ?
                                <p>You don't have an account?<span style={{color:'blue'}} onClick={() => setIsLoginView(false)}>Register</span></p> :
                                <p>You already have an account?<span style={{color:'blue'}} onClick={() => {setIsLoginView(true); setRegFail(false);}}>Login</span></p>
                            }<br/>
                            {forgot && <>
