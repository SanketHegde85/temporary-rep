export class API {
    ...
    static getPetDetails() {
        return fetch('http://localhost:8000/api/pet_details/', {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json'
            }
    ...
    static getLoginDetails() {
        return fetch('http://localhost:8000/api/login_details/', {
    ...
    static getAdoptions() {
        return fetch('http://localhost:8000/api/adoption_details/', {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json'
            }
    ...
    static getDonations() {
        return fetch('http://localhost:8000/api/donations/', {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json'
            }
